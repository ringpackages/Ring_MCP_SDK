...
func generate_architecture_diagram
    ...
    svg.save("docs/mcp_architecture.svg")
    ? "- docs/mcp_architecture.svg created successfully!"
...
func generate_flow_diagram
    ...
    svg.save("docs/mcp_flow.svg")
    ? "- docs/mcp_flow.svg created successfully!"
...
func generate_classes_diagram
    ...
    svg.save("docs/mcp_classes.svg")
    ? "- docs/mcp_classes.svg created successfully!"
...
func generate_routing_diagram
    ...
    svg.save("docs/mcp_routing_flow.svg")
    ? "- docs/mcp_routing_flow.svg created successfully!"
